...
g = Graph(
    "Tennis Return Curves vs Algorithm for Easy Difficulty"
)
series = glob(
    "rltennis/data/rl/output/results/*/hard*",
    recursive=True,
)
[("rltennis/data/rl/output/results/REINFORCE/easy_seq_len1_N2_d32_lr0.02_pi0.7", "MLP Reinforce Without Memory"),
 ("rltennis/data/rl/output/results/REINFORCE/easy_seq_len2_N2_d32_lr0.01_pi0.5", "MLP Reinforce With Memory"),
 ("rltennis/data/rl/output/results/Dropout/REINFORCE Memory/easy_seq_len2_N1_d16_lr0.0002_pi0.3", "Transformer Reinforce With Memory"),]
series = [s for s, _ in series]
